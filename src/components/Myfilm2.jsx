...
const MyFilm2 = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch('https://www.omdbapi.com/?s=harry potter&type=movie&apikey=c1aee0f5'); // Aggiunto il parametro "type=movie" per limitare i risultati ai film
  ...
  // Funzione per mescolare casualmente i movies
